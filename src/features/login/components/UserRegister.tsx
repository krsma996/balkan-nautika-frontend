...
import {ArrowRight,Check,Eye,EyeOff,LockKeyhole,Mail,UserRound,Waves} from "lucide-react";
            ...
            <div className="relative z-10">
              <div className="mb-12 flex items-center gap-3">
                ...
                <div className="leading-none">
                  ...
                  <div className="text-sm tracking-[0.28em] text-sky-400">
                    OGLASI
                  </div>
                </div>
              </div>
              ...
              <p className="mt-6 max-w-sm text-sm leading-7 text-slate-300">
                Kreirajte nalog i pristupite kompletnom svetu plovila,
                opreme, delova i nautčkih usluga.
              </p>
            </div>
