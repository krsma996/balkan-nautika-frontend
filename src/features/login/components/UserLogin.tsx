...
import {ArrowRight,Eye,EyeOff,LockKeyhole,Mail,ShieldCheck,Waves} from "lucide-react";
              ...
              <div className="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-400">
                    Vaš nalog i identitet zaštićeni su modernim
                    authentication sistemom.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center bg-white/65 p-6 sm:p-10 lg:p-14">
            <div className="mx-auto w-full max-w-md">
              ...
              <div className="mt-8 border-t border-[#385170]/10 pt-7 text-center">
                ...
                <button type="button" onClick={() => navigate("/register")} className="mt-2 text-sm font-bold text-[#385170] transition hover:text-[red]" > Kreirajte nalog </button>
              </div>
